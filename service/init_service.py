...
class SiteCacheService():
    ...
    @staticmethod
    async def query_all(cache_manager, thread_do, db, is_pub_all=False, pubsub_manager=None):
    ...
    @staticmethod
    async def query_blog_info(cache_manager, thread_do, db, is_pub_all=False, pubsub_manager=None):
    ...
    @staticmethod
    async def query_menus(cache_manager, thread_do, db, is_pub_all=False, pubsub_manager=None):
    ...
    @staticmethod
    async def query_plugins(cache_manager, thread_do, db, is_pub_all=False, pubsub_manager=None):
    ...
    @staticmethod
    async def query_article_count(cache_manager, thread_do, db, is_pub_all=False, pubsub_manager=None):
    ...
    @staticmethod
    async def query_article_sources(cache_manager, thread_do, db, is_pub_all=False, pubsub_manager=None):
    ...
    @staticmethod
    async def query_source_articles_count(cache_manager, source_id=None):
    ...
    @staticmethod
    async def query_comment_count(cache_manager, thread_do, db, is_pub_all=False, pubsub_manager=None):
    ...
    @staticmethod
    async def query_blog_view_count(cache_manager, thread_do, db, is_pub_all=False, pubsub_manager=None):
    ...
    # 下面是缓存更新
    @staticmethod
    async def update_by_sub_msg(msgs, cache_manager, thread_do, db):
        if not msgs:
            pass
        msg = msgs[0]
    ...
    @staticmethod
    # 更新博客信息
    async def update_blog_info(cache_manager, blog_info, is_pub_all=False, pubsub_manager=None):
        # 标题
        ...
        tr = cache_manager.multi_exec()
        tr.set(site_cache_keys['title'], blog_info.title)
        tr.set(site_cache_keys['signature'], blog_info.signature)
        tr.set(site_cache_keys['navbar'], blog_info.navbar)
    ...
    @staticmethod
    async def update_plugins(cache_manager, plugins, is_pub_all=False, pubsub_manager=None):
    ...
    @staticmethod
    async def update_menus(cache_manager, menus, article_types_not_under_menu, is_pub_all=False, pubsub_manager=None):
    ...
    @staticmethod
    async def update_article_count(cache_manager, article_count, is_pub_all=False, pubsub_manager=None):
        if article_count is not None:
    ...
    @staticmethod
    async def update_comment_count(cache_manager, comment_count, is_pub_all=False, pubsub_manager=None):
        if comment_count is not None:
    ...
    @staticmethod
    async def update_blog_view_count(cache_manager, pv, uv, is_pub_all=False, pubsub_manager=None):
    ...
    @staticmethod
    async def update_article_sources(cache_manager, article_sources, is_pub_all=False, pubsub_manager=None):
        if article_sources is not None:
            SiteCollection.article_sources = article_sources
    ...
    @staticmethod
    async def update_article_action(cache_manager, action, article, is_pub_all=False, pubsub_manager=None):
    ...
    @staticmethod
    async def update_comment_action(cache_manager, action, comments, is_pub_all=False, pubsub_manager=None):
        if comments:
            comment_count = 1
    ...
    @staticmethod
    async def add_pv_uv(cache_manager, add_pv, add_uv, is_pub_all=False, pubsub_manager=None):
        if add_pv or add_uv:
            if add_pv:
                await cache_manager.incrby(site_cache_keys['pv'], add_pv)
            if add_uv:
                await cache_manager.incrby(site_cache_keys['uv'], add_uv)
            # 是否发布和订阅
            # if is_pub_all:
            #     await pubsub_manager.pub_call(SiteCacheService.PUB_SUB_MSGS['blog_view_count_updated'])
        # 设置pv和uv
        SiteCollection.pv = await cache_manager.get(site_cache_keys['pv'])
        SiteCollection.uv = await cache_manager.get(site_cache_keys['uv'])
